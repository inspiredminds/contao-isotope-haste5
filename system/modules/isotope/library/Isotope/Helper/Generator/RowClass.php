...
namespace Isotope\Helper\Generator;
...
class RowClass
{
    ...
    public function addCustom($strName)
    {
        ...
        $this->strName = StringUtil::standardize((string) $strName);
    ...
    {
        $this->strKeyPrefix = StringUtil::standardize((string) $strPrefix);
    ...
    public function addCount($strPrefix)
    {
        ...
        $this->strCountPrefix = StringUtil::standardize((string) $strPrefix);
    ...
    {
        $this->strEvenOddPrefix = StringUtil::standardize((string) $strPrefix);
    ...
    {
        $this->strFirstLastPrefix = StringUtil::standardize((string) $strPrefix);
